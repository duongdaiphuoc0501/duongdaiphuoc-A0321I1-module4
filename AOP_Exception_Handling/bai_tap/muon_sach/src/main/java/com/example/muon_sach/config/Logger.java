...
public class Logger {
    ...
    @AfterThrowing(value = "execution(public * com.example.muon_sach.service.BookService.*(..))", throwing = "e")
    ...
    @After("execution(public * com.example.muon_sach.service.BookService.*(..))")
